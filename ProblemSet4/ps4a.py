...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    score = 0
    lettersNumber = calculateHandlen(hand)
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += getWordScore(userWord, lettersNumber)
                print('"{}" earned {} points. Total: {} points'.format(userWord, getWordScore(userWord, lettersNumber), score))
...
def playGame(wordList):
    ...
    while True:
        ...
        userPlayGame = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
